...
if __name__ == "__main__":
    ...
    # # FILLER FOR GRID SEARCH CODE # #

    # Shows n_components/score plot
    ...
    X_val_pca = pca.transform(X_val)  # Shape: (482, n_components)

    # Model testing
    model.fit(X_train_pca, y_train)
    val_pred = model.predict(X_val_pca)  # Shape: (482,)
...
#    print(metric(y_val, val_pred))  # median_absolute: 14112.5 / mean_squared_log: .03573
